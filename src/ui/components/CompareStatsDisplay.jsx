...
for (let [armorKey, armorValue] of Object.entries(armorStatsTwo)) {
  ...
  return (
    <div className="stats-container text-white flex flex-col sm:mt-5 w-full h-full">

      <div 
      className="bg-[url(assets/chart.png)] lg:bg-[url(assets/chartlg.png)] hover:bg-[url(assets/chartHover.png)] hover:lg:bg-[url(assets/chartHoverlg.png)] w-[16px] h-[16px] lg:w-[24px] lg:h-[24px] cursor-pointer absolute top-1 right-2 lg:top-1 lg:right-2" 
      ...
      {showRawStats && (
        <>
        <div className="w-full h-full ml-25 lg:w-2/3 lg:h-2/3 lg:ml-110  lg:mt-5">
        <DefenseChartCompare 
        ...
        <div className="w-full h-full ml-25 lg:w-2/3 lg:h-2/3 lg:ml-110 lg:mt-3">
        <OffenseChartCompare 
